...
const CowForm = () => {
  ...
  return (
    <motion.div 
      className="cow-form-container max-w-4xl mx-auto mt-10 bg-gradient-to-br from-green-100 to-white"
    ...
    >
      ...
      >
        ...
        >
          <h2 className="text-3xl font-bold text-center mb-4 text-green-800">Formulario de Vacas</h2>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg">
          <div className="grid grid-cols-2 gap-6">
            <div className="form-group mb-4">
              <label htmlFor="nombre" className="block text-lg font-semibold mb-2 text-green-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="meses" className="block text-lg font-semibold mb-2 text-green-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="peso" className="block text-lg font-semibold mb-2 text-green-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="raza" className="block text-lg font-semibold mb-2 text-green-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="genero" className="block text-lg font-semibold mb-2 text-green-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="proposito" className="block text-lg font-semibold mb-2 text-green-700">
