...
const PigForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-300 to-blue-100 font-montserrat relative flex items-center justify-center">
      <motion.div 
        className="pig-form-container max-w-4xl mx-auto mt-10"
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="form-group mb-4">
                <label htmlFor="imagen" className="block text-lg font-semibold mb-2 text-pink-700">
              ...
              <div className="form-group mb-4">
                <label htmlFor="detalles_adicionales" className="block text-lg font-semibold mb-2 text-pink-700">
