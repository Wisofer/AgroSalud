...
import { faHorse, faCalendarAlt, faTag, faWeight, faVenusMars, faClipboardList } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 className="text-3xl font-bold text-center mb-4 text-yellow-800">Formulario de Cabra</h2>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg">
          <div className="grid grid-cols-2 gap-6">
            <div className="form-group mb-4">
              <label htmlFor="nombre" className="block text-lg font-semibold mb-2 text-yellow-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="fechaNacimiento" className="block text-lg font-semibold mb-2 text-yellow-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="numeroEtiqueta" className="block text-lg font-semibold mb-2 text-yellow-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="peso" className="block text-lg font-semibold mb-2 text-yellow-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="raza" className="block text-lg font-semibold mb-2 text-yellow-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="genero" className="block text-lg font-semibold mb-2 text-yellow-700">
            ...
            <div className="form-group mb-4">
              <label htmlFor="proposito" className="block text-lg font-semibold mb-2 text-yellow-700">
          ...
          <div className="mt-6">
            <button type="submit" className="w-full bg-yellow-500 text-white py-3 px-4 rounded-lg hover:bg-yellow-600 transition duration-300">
              Enviar
            </button>
          </div>
        </form>
